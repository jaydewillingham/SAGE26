...
extern "C" {
    ...
    extern void grow_black_hole(const int merger_centralgal, const double mass_ratio, const int from_instability, const double dt, struct GALAXY *galaxies, const struct params *run_params);    
