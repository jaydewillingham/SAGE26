...
extern "C" {
    ...
    extern void quasar_mode_wind(const int gal, const double BHaccrete, const double dt, struct GALAXY *galaxies, const struct params *run_params);
    ...
    extern void grow_black_hole(const int merger_centralgal, const double mass_ratio, const double dt, struct GALAXY *galaxies, const struct params *run_params);
    extern void grow_black_hole_instability(const int gal, const double unstable_gas, const double dt, struct GALAXY *galaxies, const struct params *run_params);
